...
export default function ServicesPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 text-gray-100">
      ...
      <p className="text-gray-200 mb-8">Explore our full suite of services. Details align with the legal pack.</p>
          ...
          <section key={pillar} className="border border-dlq-gold/30 rounded-lg bg-[#0f2238] p-5">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {getServicesByPillar(pillar).map((s) => (
                <a key={s.slug} href={`/services/${s.slug}`} className="block border border-dlq-gold/20 rounded-lg p-4 hover:bg-white/5 transition">
