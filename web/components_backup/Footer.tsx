        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/legal/buyer-protection" className="text-gray-400 hover:text-brand-gold transition-colors duration-300 text-sm">Buyer Protection</Link></li>
              <li><Link href="/legal/partner-agreement" className="text-gray-400 hover:text-brand-gold transition-colors duration-300 text-sm">Partner Agreement</Link></li>
              <li><Link href="/legal/merchant-agreement" className="text-gray-400 hover:text-brand-gold transition-colors duration-300 text-sm">Merchant Agreement</Link></li>
            </ul>
          </div>
        </div>
